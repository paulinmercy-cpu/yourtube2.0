...
const VideoInfo = ({ video }: any) => {
  ...
  const [watchLaterCount, setWatchLaterCount] = useState(
    video?.watchLater || 0
  );
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="flex items-center bg-gray-100 rounded-full overflow-hidden">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm ${
                liked ? "bg-black text-white" : "hover:bg-gray-200"
              }`}
            >
              <ThumbsUp size={16} />
              {likes}
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 text-sm ${
                disliked ? "bg-black text-white" : "hover:bg-gray-200"
              }`}
            >
              <ThumbsDown size={16} />
              {dislikes}
          ...
          {downloadBlocked && (
            <div className="text-sm text-red-600">
              ⚠️ Free limit reached. Upgrade to Premium.
            </div>
          )}
